...
function farm(num){
	if(num<=10)
		return "It's cold outside! Reconsider about your farming practice";
	else if (num>10 && num<40)
		return "Weather is good ! Go for farming";
...
{cityName = document.getElementById('city').value;}
	...
	request.onload = function(){
		...
		if (request.status >= 200 && request.status < 400) {
			...
			document.getElementById('farming').innerHTML = farm(temp);
